...
import { AddressInCustomer } from "./AddressInCustomerList";
...
export const CustomerDetail = () => {
    ...
    const loadingData = useCallback(async () => {
        setLoading(true);
        const response = await getReqeust(`crm/customer/${params.id}`);
                ...
                >
                    <Group>
                        ...
                        <NavButton 
                            ...
                            click={() => navigate('/crm/customer/new')}
                            disabled={loading}
                        />
